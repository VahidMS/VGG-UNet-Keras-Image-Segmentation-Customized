#@title _unet and vgg_net {form-width: '10%'}
#original version from: keras_segmentation/models/unet.py
...
model = vgg_unet(2, input_height=64, input_width=64)
model.summary()
print(model.output_height)
